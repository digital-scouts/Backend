...
var ChatController = /** @class */ (function () {
     ...
     * @return {Promise<any>}
     */
    ChatController.createNewChat = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            function checkFlag() {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(length != pushed)) return [3 /*break*/, 1];
                                setTimeout(checkFlag, 100);
                                return [3 /*break*/, 3];
                            case 1:
                                chat = new chatModel_1.Chat({ roomName: request.body.chatName, user: users });
                                ...
                                return [4 /*yield*/, chat.save().then(function (chat) {
            ...
            var users, length, pushed;
            return __generator(this, function (_a) {
                users = [request.decoded.userID];
                length = 0;
                pushed = 0;
     ...
     * @param next
     */
    ChatController.newTextMessage = function (request, response, next) {
     ...
     * @param messageID
     */
    ChatController.sendMessage = function (chatID, messageID) {
